...
public class criarAcessorio extends JFrame{
	...
	public criarAcessorio(String titulo, Vector<Item> itens) {
		super(titulo);
        ...
        adicionar_tipo.setText("ex: Relógio");
        ...
        adicionar_conservacao.setText("ex: Usado");
        ...
        adicionar_lojaOrigem.setText("ex: Rolex");
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            Item novoAcessorio = new Acessorio(novoTipo,novaCor,novaLojaOrigem,novaConservacao,novaQntUso);
			ExcluirTudo excluidor = new ExcluirTudo();
			itens.add(novoAcessorio);
