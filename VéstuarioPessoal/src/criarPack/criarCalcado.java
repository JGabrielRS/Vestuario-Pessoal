...
public class criarCalcado extends JFrame{
	...
	public criarCalcado(String titulo, Vector<Item> itens) {
		super(titulo);
        ...
        adicionar_tipo.setText("ex: Tênis");
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            Item novoCalcado = new Calcado(novoTipo,novaCor,novoTamanho,novaLojaOrigem,novaConservacao,novaQntLavagem,novaQntUso);
			ExcluirTudo excluidor = new ExcluirTudo();
			itens.add(novoCalcado);
