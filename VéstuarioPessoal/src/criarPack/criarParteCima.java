...
public class criarParteCima extends JFrame{
	...
	public criarParteCima(String titulo, Vector<Item> itens) {
		super(titulo);
        ...
        adicionar_tipo.setText("ex: Camisa");
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            Item novoParteCima = new ParteCima(novoTipo,novaCor,novoTamanho,novaLojaOrigem,novaConservacao,novaQntLavagem,novaQntUso);
			ExcluirTudo excluidor = new ExcluirTudo();
			itens.add(novoParteCima);
