...
public class criarParteBaixo extends JFrame{
	...
	public criarParteBaixo(String titulo, Vector<Item> itens) {
		super(titulo);
        ...
        adicionar_tipo.setText("ex: Calça");
        ...
        adicionar_tamanho.setText("ex: 38");
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            Item novoParteBaixo = new ParteBaixo(novoTipo,novaCor,novoTamanho,novaLojaOrigem,novaConservacao,novaQntLavagem,novaQntUso);
			ExcluirTudo excluidor = new ExcluirTudo();
			itens.add(novoParteBaixo);
