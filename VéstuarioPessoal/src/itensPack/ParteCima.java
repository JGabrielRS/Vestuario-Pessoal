...
public class ParteCima extends Item implements IEmprestavel, ILavavel{
	
	public ParteCima(String tipo) {
		super(tipo);
		this.tipo = tipo;
		cor = null;
		tamanho = null;
	...
	public ParteCima(String tipo, String cor, String tamanho, String lojaOrigem, String conservacao) {
		super(tipo);
		this.tipo = tipo;
		this.cor = cor;
	...
	public ParteCima(String tipo, String cor, String tamanho, String lojaOrigem, String conservacao, int qntLavagens, int qntUso) {
		super(tipo, cor, lojaOrigem, conservacao);
		this.parte= "ParteCima";
		this.tipo = tipo;
		this.cor = cor;
		this.tamanho = tamanho;
		this.lojaOrigem = lojaOrigem;
	...
	public ParteCima(String tipo, String cor, String tamanho, String lojaOrigem, String conservacao, String emprestado, LocalDate inEmp, LocalDate fimEmp, int qntLavagens, int qntUso) {
		super(tipo, cor, lojaOrigem, conservacao);
		this.parte= "ParteCima";
		this.tipo = tipo;
		this.cor = cor;
