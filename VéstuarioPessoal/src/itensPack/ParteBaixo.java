...
public class ParteBaixo extends Item implements IEmprestavel, ILavavel{
	
	public ParteBaixo(String tipo) {
		super(tipo);
		this.tipo = tipo;
		cor = null;
		tamanho = null;
	...
	public ParteBaixo(String tipo, String cor, String tamanho, String lojaOrigem, String conservacao) {
		super(tipo);
		this.tipo = tipo;
		this.cor = cor;
	...
	public ParteBaixo(String tipo, String cor, String tamanho, String lojaOrigem, String conservacao, String emprestado, LocalDate inEmp, LocalDate fimEmp, int qntLavagens, int qntUso) {
		super(tipo, cor, lojaOrigem, conservacao);
		this.parte = "ParteBaixo";
		this.tipo = tipo;
		this.cor = cor;
		this.tamanho = tamanho;
		this.lojaOrigem = lojaOrigem;
	...
	public ParteBaixo(String tipo, String cor, String tamanho, String lojaOrigem, String conservacao, int qntLavagens, int qntUso) {
		super(tipo, cor, lojaOrigem, conservacao);
		this.parte = "ParteBaixo";
		this.tipo = tipo;
		this.cor = cor;
