...
public class EditorParteIntima extends JFrame{
	...
	public EditorParteIntima(String titulo, Item parteIntima, Vector<Item> itens) {
		super(titulo);
        ...
        ft_parteCima.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        
        JLabel nome_parteCima = new JLabel(parteIntima.getTipo(), SwingConstants.CENTER);
        ...
        editar_cor.setText(parteIntima.getCor());
        ...
        editar_conservacao.setText(parteIntima.getConservacao());
        ...
        editar_tamanho.setText(parteIntima.getTamanho());
        ...
        editar_qntLavagem.setText(Integer.toString(parteIntima.getQntLavagem()));
        ...
        editar_lojaOrigem.setText(parteIntima.getLojaOrigem());
        ...
        editar_qntUso.setText(Integer.toString(parteIntima.getQntUso()));
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            parteIntima.mudar_cor(novaCor);
            parteIntima.mudar_conservacao(novaConservacao);
            parteIntima.mudarTamanho(novoTamanho);
            parteIntima.mudarQntLavagem(novaQntLavagem);
            parteIntima.mudar_lojaOrigem(novaLojaOrigem);
            parteIntima.mudarQntUso(novaQntUso);
			ExcluirTudo excluidor = new ExcluirTudo();
			itens.add(parteIntima);
