...
public class EditorParteCima extends JFrame{
	private Item parteCima;
	...
	public EditorParteCima(String titulo, Item parteCima, Vector<Item> itens) {
		super(titulo);
        ...
        editar_cor.setText(parteCima.getCor());
        ...
        editar_conservacao.setText(parteCima.getConservacao());
        ...
        editar_tamanho.setText(parteCima.getTamanho());
        ...
        editar_qntLavagem.setText(Integer.toString(parteCima.getQntLavagem()));
        ...
        editar_lojaOrigem.setText(parteCima.getLojaOrigem());
        ...
        editar_qntUso.setText(Integer.toString(parteCima.getQntUso()));
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            parteCima.mudar_cor(novaCor);
            parteCima.mudar_conservacao(novaConservacao);
            parteCima.mudarTamanho(novoTamanho);
            parteCima.mudarQntLavagem(novaQntLavagem);
            parteCima.mudar_lojaOrigem(novaLojaOrigem);
            parteCima.mudarQntUso(novaQntUso);
