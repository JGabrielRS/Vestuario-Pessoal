...
public class EditorAcessorio extends JFrame{
	private Item acessorio;
	...
	public EditorAcessorio(String titulo, Item acessorio, Vector<Item> itens) {
		super(titulo);
        ...
        // foto e tipo
        JLabel ft_parteCima = new JLabel(acessorio_redim, SwingConstants.CENTER);
        ft_parteCima.setPreferredSize(new Dimension(200, 200));
        
        JLabel nome_parteCima = new JLabel(acessorio.getTipo(), SwingConstants.CENTER);
        ...
        editar_cor.setText(acessorio.getCor());
        ...
        editar_conservacao.setText(acessorio.getConservacao());
        ...
        editar_tamanho.setText(acessorio.getTamanho());
        ...
        editar_qntLavagem.setText(Integer.toString(acessorio.getQntLavagem()));
        ...
        editar_lojaOrigem.setText(acessorio.getLojaOrigem());
        ...
        editar_qntUso.setText(Integer.toString(acessorio.getQntUso()));
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            acessorio.mudar_cor(novaCor);
            acessorio.mudar_conservacao(novaConservacao);
            acessorio.mudarTamanho(novoTamanho);
            acessorio.mudarQntLavagem(novaQntLavagem);
            acessorio.mudar_lojaOrigem(novaLojaOrigem);
            acessorio.mudarQntUso(novaQntUso);
