...
public class EditorParteBaixo extends JFrame{
	private Item parteBaixo;
	...
	public EditorParteBaixo(String titulo, Item parteBaixo, Vector<Item> itens) {
		super(titulo);
        ...
        // foto e tipo
        JLabel ft_parteCima = new JLabel(calca_redim, SwingConstants.CENTER);
        ft_parteCima.setPreferredSize(new Dimension(200, 200));
        
        JLabel nome_parteCima = new JLabel(parteBaixo.getTipo(), SwingConstants.CENTER);
        ...
        editar_cor.setText(parteBaixo.getCor());
        ...
        editar_conservacao.setText(parteBaixo.getConservacao());
        ...
        editar_tamanho.setText(parteBaixo.getTamanho());
        ...
        editar_qntLavagem.setText(Integer.toString(parteBaixo.getQntLavagem()));
        ...
        editar_lojaOrigem.setText(parteBaixo.getLojaOrigem());
        ...
        editar_qntUso.setText(Integer.toString(parteBaixo.getQntUso()));
	...
	private void salvarAlteracoes(Vector<Item> itens) {
		try {
            ...
            parteBaixo.mudar_cor(novaCor);
            parteBaixo.mudar_conservacao(novaConservacao);
            parteBaixo.mudarTamanho(novoTamanho);
            parteBaixo.mudarQntLavagem(novaQntLavagem);
            parteBaixo.mudar_lojaOrigem(novaLojaOrigem);
            parteBaixo.mudarQntUso(novaQntUso);
			ExcluirTudo excluidor = new ExcluirTudo();
			itens.add(parteBaixo);
